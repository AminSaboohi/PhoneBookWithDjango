...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields[
            'username'
        ].help_text = ('<span class="form-text '
                       'text-muted"><small>Required. 150 '
                       'characters or fewer. Letters, digits '
        ...
        self.fields[
            'password2'
                       ...
                       'text-muted"><small>Enter the same '
                       'password as before, '
